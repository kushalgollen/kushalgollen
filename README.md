...
* **[5-Axis Robotic Manipulator & Kinematics Pipeline](https://github.com/kushalgollen)** *(C++, ROS 2 Humble, MoveIt 2, micro-ROS)* (To be loaded)
...
* **[Bio-Inspired Multi-Legged Walking Robot]** *(C++, Embedded C, CAD)*
